...
<img src="https://i.imgur.com/MFF46ov.jpg[/img]" class="imgbook">
 <p class="book_details">
<span class="span1">Grant</span><br> <!--Book id = "1033"-->
 <span class="span2">by Ron Chernow</span><br><br>
...
<a href="book_details.php?id=1033">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>

<div class="divinner">
<img src="https://i.imgur.com/4abOGyk.jpg[/img]" class="imgbook">
<p class="book_details">
<span class="span1">Embers of War: The Fall of an Empire and the Making of America's Vietnam</span><br> <!--Book id = "1034"-->
<span class="span2">by Fredrik Logevall</span><br><br>
...
<a href="book_details.php?id=1034">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>
...
<img src="https://i.imgur.com/rHBt86F.jpg[/img]" class="imgbook">
<p class="book_details">
<span class="span1">The History of the Ancient World</span><br> <!--Book id = "1035"-->
<span class="span2">by Susan Wise Bauer</span><br><br>   
...
<a href="book_details.php?id=1035">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>
...
<img src="https://i.imgur.com/iY3TyxB.jpg[/img]" class="imgbook">
<p class="book_details">
<span class="span1">Democracy: A Life</span><br> <!--Book id = "1036"-->
<span class="span2">by Paul Cartledge</span><br><br>   
...
<a href="book_details.php?id=1036">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>
</div>
...
<div class="divinner">
<img src="https://i.imgur.com/w8eUlp7.jpg[/img]" class="imgbook">
<p class="book_details">
<span class="span1">Frederick Douglas: Prophet of Freedom</span><br> <!--Book id = "1037"-->
<span class="span2">by David W. Blight</span><br><br>
...
<a href="book_details.php?id=1037">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>

<div class="divinner">
<img src="https://i.imgur.com/fBhyk8O.jpg[/img]" class="imgbook">
<p class="book_details">
<span class="span1">Appeasement</span><br> <!--Book id = "1038"-->
<span class="span2">by Tim Bouverie</span><br><br>
...
<a href="book_details.php?id=1038">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>

<div class="divinner">
<img src="https://i.imgur.com/ucgPkW7.jpg[/img]" class="imgbook">
<p class="book_details">
<span class="span1">Iran: A Modern History</span><br> <!--Book id = "1039"-->
<span class="span2">by Abbas Amanat</span><br><br>
This history of modern Iran is not a survey in the conventional sense but an ambitious exploration of the story of a nation. It offers a revealing look at how events, people, and institutions are shaped by currents that sometimes reach back hundreds of years. The book covers the complex history of the diverse societies and economies of Iran against the background of dynastic changes, revolutions, civil wars, foreign occupation, and the rise of the Islamic Republic.
</p>
<a href="book_details.php?id=1039">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>

<div class="divinner">
<img src="https://i.imgur.com/i0ayGHB.jpg[/img]" class="imgbook">
<p class="book_details">
<span class="span1">Encounters at the Heart of the World: A History of the Mandan People</span><br> <!--Book id = "1040"-->
<span class="span2">by Elizabeth A. Fenn</span><br><br>
...
<a href="book_details.php?id=1040">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>
</div>
