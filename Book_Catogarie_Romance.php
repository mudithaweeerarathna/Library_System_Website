...
<img src="https://i.imgur.com/dtMYJuT.jpeg" class="imgbook">
<p class="book_details">
<span class="span1">It Ends With Us</span><br> <!--Book id = "1009"-->
<span class="span2">by Colleen Hoover</span><br><br>
...
<a href="book_details.php?id=1009">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>

<div class="divinner">
<img src="https://i.imgur.com/1mZZ6lJ.jpeg" class="imgbook">
<p class="book_details">
<span class="span1">Beautiful Disaster</span><br> <!--Book id = "1010"-->
<span class="span2">by Jamie McGuire</span><br><br>
...
<a href="book_details.php?id=1010">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>
...
<img src="https://i.imgur.com/2S3pHvC.jpeg" class="imgbook">
<p class="book_details">
<span class="span1">Love At First Like</span><br> <!--Book id = "1011"-->
<span class="span2">by Hannah Orenstein</span><br><br>   
...
<a href="book_details.php?id=1011">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>
...
<img src="https://i.imgur.com/1o4nx2V.jpeg" class="imgbook">
<p class="book_details">
<span class="span1">The Duke And I</span><br> <!--Book id = "1012"-->
<span class="span2">by Julia Quinn</span><br><br>   
...
<a href="book_details.php?id=1012">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>
</div>
...
<p class="book_details">
<span class="span1">Blood Like Magic</span><br> <!--Book id = "1013"-->
<span class="span2">by Liselle Sambury</span><br><br>
...
<a href="book_details.php?id=1013">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>

<div class="divinner">
<img src="https://i.imgur.com/dKBxL6G.jpg[/img]" class="imgbook">
<p class="book_details">
<span class="span1">Seven Days in June</span><br> <!--Book id = "1014"-->
<span class="span2">by Tia Williams</span><br><br>
...
<a href="book_details.php?id=1014">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>

<div class="divinner">
<img src="https://i.imgur.com/B8OW1XV.jpg[/img]" class="imgbook">
<p class="book_details">
<span class="span1">One Last Stop</span><br> <!--Book id = "1015"-->
<span class="span2">by Casey McQuiston</span><br><br>
...
<a href="book_details.php?id=1015">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>

<div class="divinner">
<img src="https://i.imgur.com/wUtka4d.jpg[/img]" class="imgbook">
<p class="book_details">
<span class="span1">The Portrait of a Mirror</span><br> <!--Book id = "1016"-->
<span class="span2">by A. Natasha Joukovsky</span><br><br>
...
<a href="book_details.php?id=1016">
    <button class="submit-button-class" type="submit" name="submit">Further Details</button>
</a>
</div>
</div>
